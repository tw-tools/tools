...
@Component
public class ImagesResizeResizeBackendImpl implements ImagesResizeQueue,
    JobImagesResizeBackendGateway {

    private final MessageChannel imagesResizeChannel;

    @Autowired
    public ImagesResizeResizeBackendImpl(
    ...
    private Log logger = LogFactory.getLog(ImagesResizeResizeBackendImpl.class);
}
