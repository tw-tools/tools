...
@Component
public class JobRenameFilesBackendGatewayImpl implements JobRenameFilesBackendGateway {

    private final MessageChannel renameFilesChannel;

    @Autowired
    public JobRenameFilesBackendGatewayImpl(
    ...
    private Log logger = LogFactory.getLog(JobRenameFilesBackendGatewayImpl.class);
}
