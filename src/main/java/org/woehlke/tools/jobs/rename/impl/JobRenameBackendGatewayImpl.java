...
import static org.woehlke.tools.config.properties.QueueNames.JOB_RENAME_FILES_QUEUE;
import static org.woehlke.tools.config.properties.QueueNames.JOB_RENAME_FILES_QUEUE_REPLY;
...
public class JobRenameBackendGatewayImpl implements JobRenameBackendGateway {
    ...
    public void sendMessage(String payload, String category, JobCase job) {
        ...
        headers.put(REPLY_CHANNEL, JOB_RENAME_FILES_QUEUE_REPLY);
